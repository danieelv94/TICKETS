<?php if(!$_SESSION['nombre']==""&&!$_SESSION['tipo']==""){ 
        ...
        if(isset($_POST['name_complete_update']) && isset($_POST['old_user_update']) && isset($_POST['new_user_update']) && isset($_POST['old_pass_update']) && isset($_POST['new_pass_update'])){
          ...
          if(mysqli_num_rows($sql)>=1){
            MysqlQuery::Actualizar("usuario", "nombre_completo='$nombre_complete_update', nombre_usuario='$new_user_update', email_usuario='$email_update', clave='$new_pass_update'", "nombre_usuario='$old_user_update' and clave='$old_pass_update'");
