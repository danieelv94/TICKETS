...
$email_consul = $_SESSION['email_usuario'];
...
$consulta_tablaTicket = Mysql::consulta("SELECT * FROM ticket WHERE email_usuario = '$email_consul'");

if (mysqli_num_rows($consulta_tablaTicket) >= 1) {
    while ($lsT = mysqli_fetch_array($consulta_tablaTicket, MYSQLI_ASSOC)) {
?>
        <div class="container">
            <div class="row well">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10 lead text-justify">
                    ...
                    <p>Si su <strong>ticket</strong> no ha sido solucionado aún, espere pacientemente, estamos trabajando para resolver su problema y darle una solución.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-success">
                        <div class="panel-heading text-center">
                            <h4><i class="fa fa-ticket"></i> Ticket &nbsp;#<?php echo $lsT['serie']; ?></h4>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <br>
                                            <div class="row">
                                                <div class="col-sm-6"><strong>Dirección:</strong> <?php echo $lsT['departamento']; ?></div>
                        ...
                        <div class="panel-footer text-center">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <button id="save-<?php echo $lsT['serie']; ?>" class="btn btn-success" data-id="<?php echo $lsT['serie']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp; Guardar ticket en PDF</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function(){
                $("button#save-<?php echo $lsT['serie']; ?>").click(function (){
    ...
    <div class="container">
        <div class="row  animated fadeInDownBig">
            ...
            <div class="col-sm-7 text-center">
                <h1 class="text-danger">No se encontraron tickets</h1>
                <h3 class="text-primary">Por favor verifique que ha generado tickets o que su sesión está activa.</h3>
